	...
	<body>
        ...
        <main>    
			<h1>6. The Soft Т</h1>
                ...
                <button type="button">great (hard Т)</button>
                ...
                <button type="button">great (soft Т)</button>
			
				<p>The table below compares words and phrases with soft т's to those with hard т's. Two of the three words or phrases in the left column are incorrect, and do not actually exist. The word "говорит" does exist; it is the он conjugation of говорить. All the words in the right column are all correct. Click on the words to hear how they are pronounced with both hard and soft т's. Missionaries tend to pronounce words using the pronunciation in the left column. If you have that tendency, practice mimicking the correct pronunciation in the right column.</p>
				
                <table>
                    <thead>
                        <tr>
                            <th colspan=3>Soft Т vs. Hard Т (Correct vs. Incorrect Pronunciation)</th>
                        </tr>
                        <tr>
                            <th>Soft Т (Correct)</th>
                            <th>Hard Т (Incorrect)</th>
                            <th>Meaning</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><button type="button">читать</button></td>
                            <td><button type="button">читат</button></td>
                            <td>To read</td>
                        </tr>
                        <tr>
                            <td><button type="button">говорить</button></td>
                            <td><button type="button">говорит</button></td>
                            <td>To speak</td>
                        </tr>
                        <tr>
                            <td><button type="button">Вы знаете</button></td>
                            <td><button type="button">Вы знаетэ</button></td>
                            <td>You know</td>
                        </tr>
                    </tbody>
                </table>
